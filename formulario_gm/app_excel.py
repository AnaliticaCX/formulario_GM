...
def guardar_datos(chasis, opcion1, respuesta1, aleatorio2, opcion2=None, respuesta2=None, opcion3=None, respuesta3=None):
    data = {
        "Chasis": [chasis],
        "Opcion1": [opcion1],
    ...
    if chasis and not st.session_state.formulario_completado:
        ...
        if col1.button("Sí"):
            ...
            if len(st.session_state.respuestas) == 0:
                guardar_datos(chasis, st.session_state.opcion_actual, "Sí", st.session_state.aleatorio2 if st.session_state.aleatorio2 else "No")
            elif len(st.session_state.respuestas) == 1:
                guardar_datos(chasis, st.session_state.respuestas[0][0], st.session_state.respuestas[0][1], st.session_state.aleatorio2, st.session_state.opcion_actual, "Sí")
            elif len(st.session_state.respuestas) == 2:
                guardar_datos(chasis, st.session_state.respuestas[0][0], st.session_state.respuestas[0][1], st.session_state.aleatorio2, st.session_state.respuestas[1][0], st.session_state.respuestas[1][1], st.session_state.opcion_actual, "Sí")
